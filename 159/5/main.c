...
int cur_pid, sys_tick, product_num, common_sid, print_sid;	// current running PID, -1 means no process
...
void InitControl()
{
	...
	SetIDTEntry(TIMER_INTR, TimerEntry); // prime IDT with an entry
